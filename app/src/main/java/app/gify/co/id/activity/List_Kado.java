...
public class List_Kado extends AppCompatActivity {
    ...
    private void getBarang() {
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, "http://192.168.43.19/gify/api/barangkado.php", null, new Response.Listener<JSONObject>() {
            @Override
